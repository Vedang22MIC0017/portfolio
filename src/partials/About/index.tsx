    ...
    <Section name="about" className={style.root}>
      ...
      <Container grid>
        <Row start={1} end={3}>
          <ContentBlock>
            <List>
              <ListItem end="x1">AWS Certified Cloud Practitioner</ListItem>
              <ListItem end="x1">AWS Certified Developer</ListItem>
              <ListItem end="x1">Google Cloud Certified</ListItem>
              <ListItem end="x1">Microsoft Certified</ListItem>
            </List>
          </ContentBlock>
        </Row>
      </Container>
